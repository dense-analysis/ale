...
function! ale#fixers#js_beautify_html#ExtractHTMLPortion(buffer) abort
    let l:buffer_lines = getline(a:buffer, '$')
    let [l:first_line, l:last_line] = s:TemplateLineRangeDelimiter(a:buffer, l:buffer_lines)
"echo buffer_lines[l:first_line : l:last_line]
    return buffer_lines[l:first_line : l:last_line]
endfunction

function! ale#fixers#js_beautify_html#ProcessHTMLPortion(buffer, output) abort
    let l:buffer_lines = getline(a:buffer, '$')
    let [l:first_line, l:last_line] = s:TemplateLineRangeDelimiter(a:buffer, l:buffer_lines)
let g:kaka = ((l:first_line - 1 >= 0) ? l:buffer_lines[:l:first_line - 1] : [])
let g:kaka2 =  l:buffer_lines[l:first_line : l:last_line]
let g:kaka3 = l:buffer_lines[l:last_line + 1:]
...
function! ale#fixers#js_beautify_html#Fix(buffer) abort
    ...
    "\   'process_with': 'ale#fixers#js_beautify_html#ProcessHTMLPortion',
    ...
    \   'input': ale#fixers#js_beautify_html#ExtractHTMLPortion(a:buffer),
    \}
endfunction
